...
- icon pack update 01.12.2022

1.8.45 - @m00nyONE
- icon pack update 21.11.2022
- TODO update
- adding ticket system for icon requests for better organization

1.8.44 - @m00nyONE
- icon pack update 13.11.2022

1.8.43 - @m00nyONE
- icon pack update 09.11.2022
- adding TODO.md list

1.8.42 - @m00nyONE
- icon pack update 05.11.2022

1.8.41 -@m00nyONE
- Icon pack update 01.11.2022
