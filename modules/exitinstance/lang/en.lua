...
local strings = {
    ...
    HR_MODULES_EXITINSTANCE_BINDING_SENDEXITINSTANCEREQUEST = "Eject Group",
    ...
    HR_MODULES_EXITINSTANCE_DIALOG_TITLE = "Eject Group",
    HR_MODULES_EXITINSTANCE_DIALOG_MAIN_TEXT = "Do you want everyone to leave the instance (including yourself)?",
