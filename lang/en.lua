...
local strings = {
	...
	HR_MENU_ICONS_SECTION_CUSTOM = "Custom names",
	HR_MENU_ICONS_NOLIBSINSTALLED = "For the full experience of HodorReflexes, please make sure the following library is installed:\n\n - |cFFFF00LibCustomNames|r – Displays custom names for friends, guildmates, and more.\n\nThis library enhances the visual experience and allows for more personalization but is not required for basic functionality. It's your choice if you want to have it installed or not.",
	HR_MENU_ICONS_README_1 = "LibCustomNames\n\nPlease send YoZoPoClo 1M gold on Xbox NA for a custom name. You need to provide the name and the colour.\n",
