...
local strings = {
    ...
    --HR_MODULES_DPS_MENU_ONLY_SHOW_DAMAGEDEALERS = "Only Show Damage Dealers",
    --HR_MODULES_DPS_MENU_ONLY_SHOW_DAMAGEDEALERS_TT = "Only show players with the damage dealer role in the damage list.",
