...
local strings = {
    ...
    HR_MODULES_DPS_MENU_ONLY_SHOW_DAMAGEDEALERS = "Zeige nur DDs",
    HR_MODULES_DPS_MENU_ONLY_SHOW_DAMAGEDEALERS_TT = "Zeigt nur DDs in der Liste an. Wenn deaktiviert, werden auch Heiler und Tanks angezeigt.",
